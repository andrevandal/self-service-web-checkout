...
let successful = runCommand("Vendored OpenCode skills update", [
  "bunx",
  "skills",
  "update",
]);
successful =
  runWhenAvailable(
    "OMP Superpowers upgrade",
    "omp",
    ["omp", "plugin", "upgrade", "superpowers@superpowers-marketplace"],
  ) && successful;
successful =
  runWhenAvailable(
    "Gemini CLI Superpowers update",
    "gemini",
    ["gemini", "extensions", "update", "superpowers"],
  ) && successful;
successful =
  runWhenAvailable(
    "GitHub Copilot CLI Superpowers update",
    "copilot",
    ["copilot", "plugin", "update", "superpowers@superpowers-marketplace"],
  ) && successful;
successful =
  runWhenAvailable(
    "Factory Droid Superpowers update",
    "droid",
