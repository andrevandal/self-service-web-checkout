...
Required doc deliverables for this scaffold: `README.md` (project
overview, setup instructions, the badges from
...
- `CLAUDE.md` is a working symlink whose resolved content is byte-identical
  to `AGENTS.md`.
- `README.md` documents installation, `cp .env.example .env`, migration,
  and local test commands; it contains the Codecov, CI, license, and
  release badges. `docs/deployment.md` explains the intended use of each
  compose topology.
